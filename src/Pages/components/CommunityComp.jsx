...
export default function CommunityComp({ data }) {
    ...
    return (
        <a href={`/Community/${data.name.replaceAll(" ", "-")}`} style={{color: "#333"}} >
            <div style={{display: "flex", flexDirection: screenWidth >= 800 ? "row" : "column", alignItems: "center", overflow: "hidden", justifyContent: "start",gap: "1.75rem", width: "100%", border: "1px solid #ccc", height: screenWidth <= 800 && "500px"}} className="property">
