  ...
  return (
    <div style={{width: "100%", position: "relative", display: "flex", justifyContent: "center", alignItems: "center"}}>
      <div>
        {
          visible.indexOf(0) < 0 &&
          <div style={{position: "absolute", zIndex: "60", left: "0px", cursor: "pointer", background: "#004274", padding: "10px 15px", borderRadius: "5px", color: "#fff"}} onClick={ScrollLeft}>
      ...
      <div style={{display: "flex", alignItems: "center", justifyContent: "center", width: "100%", position: "relative"}}>
        ...
        <div style={{display: "flex", width: "100%", overflow: "scroll", gap: "10px"}} id="propsCarousel">
            {
              properties.length > 0 && developers.length > 0 && properties.slice(0, 9).map((prop, index) => {
              return (
                <a key={index} href={`/Projects/${prop.title.replaceAll(" ", "-")}`} style={{width: windowSize >= 800 ? "400px" : "80%"}}>

                  <div style={{width: "100%", display: "flex", alignItems: "center", justifyContent: "center"}} className="prop">
                    <div  style={{display: "flex", width: "456px", alignItems: "start", border: "1px solid #ccc", boxShadow: "0 1px 8px 0 #ccc", flexDirection: "column", borderRadius: "10px", overflow: "hidden", opacity: visible.indexOf(index) >= 0 ? "1" : ".4"}}>
                      ...
                      <div style={{width: "100%", padding: "10px"}}>
                        ...
                        <p style={{fontWeight: "600", color:"#000"}}>
                          <i className="ri-map-pin-fill" style={{color: "#004274", marginRight: "5px"}}></i>
      ...
      <div>
        {
          visible.indexOf(8) < 0 &&
          <div style={{position: "absolute", zIndex: "60", right: "0px", cursor: "pointer", color: "#fff", background: "#004274", padding: "10px 15px", borderRadius: "5px"}} onClick={ScrollRight}>
